    ...
    <div className="bg-surface rounded-card border border-border overflow-hidden shadow-xs">
      ...
      <div className="p-4 border-b border-border bg-stone-50/50 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Bilingual Toggle */}
          <div className="inline-flex rounded-control border border-border bg-stone-100 p-0.5 text-xs font-mono">
            <button
              type="button"
      ...
      <div className="p-5">
        <div className="bg-stone-50/75 border border-border rounded-control p-4 text-xs font-serif leading-relaxed text-text-primary relative">
          <p className="whitespace-pre-line text-stone-800 text-[13px]">{displayText}</p>
