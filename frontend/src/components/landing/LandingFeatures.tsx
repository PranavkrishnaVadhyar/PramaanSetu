...
const MODULES = [
  ...
  {
    module: 'Module 3',
    title: 'Forensic Error Level Analysis',
  ...
  {
    module: 'Module 5',
    title: 'Gradient Boosted Risk Model',
  ...
  {
    module: 'Module 6',
    title: 'Bilingual Audit Narrative',
